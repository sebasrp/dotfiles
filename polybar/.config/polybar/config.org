...
font-0 = "SF UI Display":style=Heavy:fontformat=truetype:size=10;0
...
modules-right = filesystem volume wlan battery temperature date powermenu
...
menu-5-0 = hibernate
menu-5-0-exec = systemctl hibernate
